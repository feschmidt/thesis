\section{Microwave engineering for experiments with superconducting resonators}
...
where $\Delta=\omega_0-\omega$ and $\omega_0=\frac{C+C_s}{LCC_s}$. With this, we get for the reflection parameter
\begin{equation}
