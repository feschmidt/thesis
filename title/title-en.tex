...
\vspace{10cm}
\includegraphics[width=\linewidth]{title/cover_circuit}
\end{center}
...
\begin{tabular}{p{3.5cm}l}
    ...
    Prof.~Dr.~B.J.~van Wees, & University of Groningen \\

    Prof.~Dr.~C.~Schönenberger, & University of Basel, Switzerland \\

    Dr.~J.~Prance, & Lancaster University, United Kingdom \\

    Prof.~Dr.~Y.~Blanter, & Delft University of Technology, reserve member \\
