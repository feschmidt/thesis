...
%
While during stack assembly on oxidized silicon, the polymer would only touch the substrate at the start, when attempting to delaminate the heterostructure on the pre-patterned substrates, the polymer often ripped off the PDMS carrier and would also get delaminated, see Fig.~\ref{fig:fab-hetero-challenge}(a).
%
...
%
While the transfer yield of heterostructures on sapphire and silicon nitride was only as low as \SI{50}{\percent} and \SI{0}{\percent}, respectively, we did not observe this behaviour on silicon and silicon oxide surfaces, (see Fig.~\ref{fig:fab-hetero-challenge}(b)), where all delaminated flakes would stick.
%
...
%
After stack placement on the final chip, we took several optical and atomic force microscope images to determine the graphene location with respect to alignment marks, and to identify bubble-free areas, see Fig~\ref{fig:fab-hetero-challenge}(b).
%
...
%
Without a conductive layer, the resist would consistently be exposed in the center of the junction, leading to a nano-short at this spot, see Fig.~\ref{fig:fabgJJchallenges}(a-c).
%
...
%
Cross-sectional SEM showed side-angles of approximately \SI{60}{\degree} at the contact interfaces (see Fig.~\ref{fig:fabgJJ}(g)), allowing for good overlap between metal contacts and graphene layer.
%
...
%
Figure~\ref{fig:s11NbTiN} shows the resulting reflection measurement of the best measured sample (see Fig.~\ref{fig:biascavityfab}(c)), with an internal quality factor $Q_\text{i}\approx\num{82439}$.
%
