...
%
We note that, for the devices presented in the following chapters, using BOE for etching on silicon, or lift-off for the metal base layer circumvented this challenge.
...
%
We have also fabricated and measured cavities with NbTiN as superconductor with \ce{Si3N4} dielectric and on silicon substrates with comparable RF quality factors.
%
...
While we do not have evidence to back this claim, we would like to point out that depositing dielectric on the entire chip area might degrade the film quality by damaging the superconducting layer.
%
...
\begin{figure}
	...
	\caption{
		...
		% 
		DC bias cavity on sapphire with MoRe base and top layer and \ce{Si3N4} capacitor dielectric \textbf{(a)}, and device on silicon \textbf{(b)} with aluminum base and top layer.
	}
