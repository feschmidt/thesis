...
Put \SI{15}{\percent} of PPC in anisole at \SI{50}{\celsius} while mixing with a fish magnet until it dissolves.

first recipe: Hot pick-up with PPC (doi:10.1038/ncomms11894)
1. Exfoliate the hBN and Graphene on \ce{SiO2} as explained above.
2. Place the top hBN flake under the Navitar system and put the glass slide with the PDMS/PPC on top
3. Touch with the PPC the substrate and increase the temperature. The PPC will start expanding and
covering the flake. Warm up, above \SI{55}{\celsius}. Then cool down below \SI{40}{\celsius} and lift-up. the flake along with others should be on the PPC. Tip: If you didnt lift the flake repeat the process but this time heat to \SIrange{80}{90}{\celsius} and then cool down.
4. Place the graphene below now. If the hBN is very thin then you won't be able to see it. For this case when you lift up on the previous step, draw where the hBN is and don't move its position after lifting. Ok you go down and before you touch the h-Bn to the graphene you raise the temperature at \SI{110}{\celsius}. The hot air and the deflected slide will make it difficult to align them. Then touch and go down slowly. Once the interface passes the GR/hBN you should let it expand a bit more. Now the interface of Gr/hBN should be without bubbles and blisters. Go to \SI{120}{\celsius} and then retract. The hBN should stay on top of the graphene.
5. Anneal the GR/hBN stack at \SI{170}{\celsius} for \SI{15}{\minute}.
6. place PPC again on top. Cool down and once you are below \SIrange{70}{80}{\celsius} you can touch and let the
meniscus expand. Cool down below \SI{40}{\celsius} and then pick-up. The Gr/hBn stack in on the PPC.
7. Put the bottom h-BN under the Navutar and align the stack.
8. Go down, thouch warm-up above \SI{50}{\celsius} and then cool down to pick-up as in step 3. Tip: for no
bubbles again maybe repeat step 4, folowed by step 6.
9. Place the whole stack on the desired substrate.
