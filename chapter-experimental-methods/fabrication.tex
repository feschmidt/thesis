...
% 
In 2010, Dean \textit{et al.}~\cite{deanBoronNitrideSubstrates2010} realized the use of hexagonal Boron Nitride (BN) as the (until now) best dielectric and capping layer for graphene devices, showing vast improvements with respect to device mobility.
...
% 
The highest quality BN crystals, i.e. the ones exhibiting the lowest charge defect density, are the ones made by high pressure by Kenji Watanabe and Takashi Taniguchi at NIMS, Japan~\cite{taniguchiSynthesisHighpurityBoron2007}.
