...
\begin{itemize}
	\item Place the top hBN flake under the Navitar system and put the glass slide with the PDMS/PPC on top.
	\item Touch with the PPC the substrate and increase the temperature. The PPC will start expanding and covering the flake.
	\item Warm up, above \SI{55}{\celsius}.
	\item Then cool down below \SI{40}{\celsius} and lift-up. the flake along with others should be on the PPC. Tip: If you didnt lift the flake repeat the process but this time heat to \SIrange{80}{90}{\celsius} and then cool down.
