...
%
These combined images are loaded into the CAD software (we highly recommend \textit{KLayout}\footnote{\url{https://www.klayout.de}}, or alternatively \textit{LibreCAD}\footnote{\url{https://librecad.org}}) to design the electrodes and gates for the gJJ, as shown in Fig~\ref{fig:fab-hetero-challenge}(c).
...
%
Additionally, even though wet-etching seems to be a cleaner process compared to dry-etching, the obtained microwave properties of samples fabricated using BOE did not consistently surpass those of dry-etched devices.
