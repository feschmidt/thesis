...
As depicted in Fig.\ref{fig:figure2}, we can fit the RF-measured $f_0$ versus the DC-measured $I_s^{\rm DC}$ using Eqs.~\ref{eq:Pogorzalek}-{eq:LJsin} assuming a sinusoidal CPR, shown by the black dashed line.
%
