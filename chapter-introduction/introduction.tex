...
However people continued working on it RSFQ was kept as a promise~\cite{hayakawaJosephsonComputerTechnology1986}, with clock speeds reaching several hundreds gigahertz~\cite{likharevRSFQLogicMemory1991}.
...
Limitations of current magnetic flux tunable qubits: power dissipation for many qubits.
%
Here, non-dissipative voltage tunability might be beneficial.
%
Additionally, cross-talk would be significantly reduced due to the nature of gate voltages being significantly more locally confined to a small volume than magnetic fields, potentially coupling qubits several centimeters apart from each other~\cite{dicarloDemonstrationTwoqubitAlgorithms2009}.
