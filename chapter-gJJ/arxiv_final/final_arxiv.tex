...
\noindent{\sf \LARGE A ballistic graphene superconducting microwave circuit}
...
%\bibliographystyle{natcomms}
%\bibliography{bib/cited.bib}

\begin{thebibliography}{10}
	
	\bibitem{calado_ballistic_2015a}
	Calado, V.~E. et~al.
...
%	\newblock \doi{10.1038/nnano.2015.156}.
	
	\bibitem{benshalom_quantum_2015}
	Ben~Shalom, M. et~al.
...
%	\newblock \doi{10.1038/nphys3592}.
	
	\bibitem{lee_ultimately_2015}
	Lee, G.-H. et~al.
...
%	\newblock \doi{10.1038/ncomms7181}.
	
	\bibitem{novoselov_roadmap_2012}
	Novoselov, K.~S. et~al.
	\newblock A roadmap for graphene.
	\newblock \emph{Nature} \textbf{490}(7419), 192--200 (2012).
%	\newblock \doi{10.1038/nature11458}.
	
	\bibitem{walsh_graphenebased_2017}
	Walsh, E.~D. et~al.
	\newblock Graphene-{{Based Josephson}}-{{Junction Single}}-{{Photon Detector}}.
	\newblock \emph{Physical Review Applied} \textbf{8}(2) (2017).
%	\newblock \doi{10.1103/PhysRevApplied.8.024022}.
	
	\bibitem{martinis_course_2004}
	Martinis, J.~M.
...
%	\newblock \doi{10.1016/S0924-8099(03)80037-9}.
	
	\bibitem{castellanos-beltran_development_2010}
...
%	\newblock \doi{10.1063/1.89690}.
	...
	(2015).
%	\newblock \doi{10.1088/0022-3727/48/39/395308}.
	
	\bibitem{zeng_atomic_2016a}
	Zeng, L. et~al.
...
%	\newblock \doi{10.1103/PhysRevB.77.180502}.
	
	\bibitem{sandberg_tuning_2008}
	Sandberg, M. et~al.
...
%	\newblock \doi{10.1063/1.2929367}.
	
	\bibitem{bosman_broadband_2015}
	Bosman, S.~J. et~al.
	...
	(2015).
%	\newblock \doi{10.1063/1.4935346}.
	
	\bibitem{singh_molybdenumrhenium_2014}
	Singh, V. et~al.
	...
	(2014).
%	\newblock \doi{10.1063/1.4903042}.
	
	\bibitem{pizzocchero_hot_2016}
	Pizzocchero, F. et~al.
...
%	\newblock \doi{10.1007/s12274-011-0093-1}.
	
	\bibitem{wu_quantum_2012}
	Wu, Y. et~al.
	\newblock Quantum {{Behavior}} of {{Graphene Transistors}} near the {{Scaling
			Limit}}.
	\newblock \emph{Nano Letters} \textbf{12}(3), 1417--1423 (2012).
%	\newblock \doi{10.1021/nl204088b}.
	
	\bibitem{campos_quantum_2012}
	Campos, L. et~al.
...
%	\newblock \doi{10.1103/PhysRevLett.117.237002}.
	
	\bibitem{allen_observation_2017}
	Allen, M.~T. et~al.
	\newblock Observation of {{Electron Coherence}} and
	{{Fabry}}\textendash{}{{Perot Standing Waves}} at a {{Graphene Edge}}.
	\newblock \emph{Nano Letters} \textbf{17}(12), 7380--7386 (2017).
%	\newblock \doi{10.1021/acs.nanolett.7b03156}.
	
	\bibitem{zhu_supercurrent_2018}
	Zhu, M. et~al.
...
%	\newblock \doi{10.1103/PhysRevLett.107.240501}.
	
	\bibitem{iosad_characterization_2002a}
	Iosad, N.~N. et~al.
	\newblock Characterization of the fabrication process of
	{{Nb}}/{{Al}}\textendash{}{{AlN}}\textsubscript{x}/{{Nb}} tunnel junctions with low {{R}}\textsubscript{n}{{A}} values up to 1 \SI{1}{\ohm.\micro\metre^2}
	\newblock \emph{Superconductor Science and Technology} \textbf{15}(6), 945
	(2002).
%	\newblock \doi{10.1088/0953-2048/15/6/319}.
	
	\bibitem{tolpygo_subgap_2013}
	Tolpygo, S.~K. et~al.
	\newblock Subgap {{Leakage}} in {{Nb}}/{{Al}}\textendash{}{{AlN}}\textsubscript{x}/{{Nb}} 
...
%	\newblock \doi{10.1109/TASC.2012.2227438}.
	
	\bibitem{liu_phenomenology_2017a}
	Liu, C.-X. et~al.
...
%	\newblock \doi{10.1103/PhysRevB.96.054520}.
	
	\bibitem{bretheau_tunnelling_2017a}
	Bretheau, L. et~al.
	\newblock Tunnelling spectroscopy of {{Andreev}} states in graphene.
	\newblock \emph{Nature Physics} \textbf{13}(8), 756 (2017).
%	\newblock \doi{10.1038/nphys4110}.
	
	\bibitem{chang_hard_2015}
	Chang, W. et~al.
...
%	\newblock \doi{10.1038/nnano.2014.306}.
	
	\bibitem{kjaergaard_quantized_2016}
	Kjaergaard, M. et~al.
...
%	\newblock \doi{10.1038/ncomms12841}.
	
	\bibitem{rosdahl_andreev_2018}
	Rosdahl, T.~{\"O}. et~al.
	\newblock Andreev rectifier: {{A}} nonlocal conductance signature of
	topological phase transitions.
	\newblock \emph{Physical Review B} \textbf{97}(4), 045421 (2018).
%	\newblock \doi{10.1103/PhysRevB.97.045421}.
	
	\bibitem{koch_chargeinsensitive_2007}
	Koch, J. et~al.
...
We acknowledge T\'omas \"Orn Rosdahl and Anton Akhmerov for discussions regarding theory and Srijit Goswami for discussions regarding fabrication.
This work was supported by the EU Graphene Flagship Program.
We additionally thank the Kavli Nanolab Delft for the cleanroom facilities.

\section*{Author contributions}
F.E.S and M.D.J fabricated the device and performed the measurements.
K.W. and T.T. supplied the BN bulk crystals.
F.E.S., M.D.J., and G.A.S. analysed and interpreted the data.
G.A.S. conceived the experiment and supervised the work.
F.E.S., M.D.J., and G.A.S. contributed to discussing and writing the manuscript.
...
\begin{figure}[thb]
	\centering
	\includegraphics[width=\linewidth]{figs/{fig1_final_cmyk.out}.pdf}
	\caption[]{\textbf{A gate tunable microwave cavity based on an encapsulated graphene Josephson junction. a,}
...
\begin{figure}[thb]
	\centering
	\includegraphics[width=\linewidth]{figs/{fig2_final_cmyk.out}.pdf}
...
\begin{figure}[thb]
	\centering
	\includegraphics[width=\linewidth]{figs/fig3_final}
...
\noindent {\sf \centering \LARGE Supplementary Information for:

A ballistic graphene superconducting microwave circuit

\vspace{1em}

\large Schmidt and Jenkins et al.
}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=.7\linewidth]{./figs/rfmodel}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=\linewidth]{./figs/{si_calcavities.out}.pdf}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=0.5\linewidth]{./figs/fig3_supp_bands}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=0.6\linewidth]{figs/supp_IjVj_plot}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=0.2\linewidth]{figs/{resub_repeatdev_img_cmyk.out}.pdf}
    \caption{
...
\begin{figure*}[]
    \centering
    \includegraphics[width=\linewidth]{figs/{si_2nddevice_cmyk.out}.pdf}
...
\begin{thebibliography}{10}
    ...
    \newblock \doi{10.1103/PhysRevB.74.180501}.

    \bibitem{mizuno_ballisticlike_2013}
    ...
    \newblock \doi{10.1038/ncomms3716}.

    \bibitem{dubos_josephson_2001}
    Dubos, P. et~al.
    \newblock Josephson critical current in a long mesoscopic {{S}}-{{N}}-{{S}}
      junction.
    \newblock \emph{Physical Review B} \textbf{63}(6), 064502 (2001).
    \newblock \doi{10.1103/PhysRevB.63.064502}.

    \bibitem{pozar_microwave_2012}
    Pozar, D.~M.
    ...
    \bibitem{vanduzer_principles_1999}
    ...
    \newblock \doi{10.1103/PhysRevLett.111.027001}.

    \bibitem{groth_kwant_2014}
    Groth, C.~W. et~al.
    \newblock Kwant: A software package for quantum transport.
    \newblock \emph{New Journal of Physics} \textbf{16}(6), 063065 (2014).
    \newblock \doi{10.1088/1367-2630/16/6/063065}.

    \bibitem{pillet_andreev_2010a}
    Pillet, J.-D. et~al.
