...
\blfootnote{This chapter was published in \textit{Nature Communications} \textbf{9}, 4069 (2018) \cite{schmidtBallisticGrapheneSuperconducting2018a}.}
...
This is in agreement with the fact that high transparency and doping has been observed to produce forward skewing in gJJ CPR \cite{nanda_currentphase_2017} which leads to an underestimation of $L_\text{j}$ if a sinusoidal CPR is used in the DC calculation.
...
From previous reports\cite{rosdahl_andreev_2018}, and from simulations of our channel (see Supplementary Note 7 and Supplementary Fig. 12), it is expected that there are a number of low-lying sub-gap states that could limit the value of $R_\text{sg}$.
...
\textbf{\centering\large A ballistic graphene superconducting microwave circuit\\}
